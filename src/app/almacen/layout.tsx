 ...
 * nueva dentro de `/almacen` nace protegida sin que nadie se acuerde de
 ...
 */
export default async function LayoutAlmacen({ children }: LayoutProps<'/almacen'>) {
  await exigirSeccion('almacen', 'ver');
  return (
    <>
      <SoloLectura seccion="almacen" />
      {children}
    </>
  );
}
