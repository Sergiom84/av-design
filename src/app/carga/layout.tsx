 ...
 * nueva dentro de `/carga` nace protegida sin que nadie se acuerde de
 ...
 */
export default async function LayoutCarga({ children }: LayoutProps<'/carga'>) {
  await exigirSeccion('carga', 'ver');
  return (
    <>
      <SoloLectura seccion="carga" />
      {children}
    </>
  );
}
