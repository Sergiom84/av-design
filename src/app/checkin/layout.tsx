 ...
 * nueva dentro de `/checkin` nace protegida sin que nadie se acuerde de
 ...
 */
export default async function LayoutCheckin({ children }: LayoutProps<'/checkin'>) {
  await exigirSeccion('checkin', 'ver');
  return (
    <>
      <SoloLectura seccion="checkin" />
      {children}
    </>
  );
}
