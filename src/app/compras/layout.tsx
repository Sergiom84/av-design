 ...
 * nueva dentro de `/compras` nace protegida sin que nadie se acuerde de
 ...
 */
export default async function LayoutCompras({ children }: LayoutProps<'/compras'>) {
  await exigirSeccion('compras', 'ver');
  return (
    <>
      <SoloLectura seccion="compras" />
      {children}
    </>
  );
}
