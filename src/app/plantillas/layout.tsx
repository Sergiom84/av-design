 ...
 * nueva dentro de `/plantillas` nace protegida sin que nadie se acuerde de
 ...
 */
export default async function LayoutPlantillas({ children }: LayoutProps<'/plantillas'>) {
  await exigirSeccion('plantillas', 'ver');
  return (
    <>
      <SoloLectura seccion="plantillas" />
      {children}
    </>
  );
}
