 ...
 * nueva dentro de `/salas` nace protegida sin que nadie se acuerde de
 ...
 */
export default async function LayoutSalas({ children }: LayoutProps<'/salas'>) {
  await exigirSeccion('salas', 'ver');
  return (
    <>
      <SoloLectura seccion="salas" />
      {children}
    </>
  );
}
